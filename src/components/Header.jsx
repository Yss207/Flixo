...
const Header = () => {
  ...
  return (
    <div className="fixed w-full px-8 py-2 bg-linear-to-b from-black z-50 flex flex-col md:flex-row justify-between items-center transition-all duration-300">
